export const Messages = {
  errors: {
    ...
    memoryNameRequired: 'A name is required for this Translation Memory operation.',
    memoryIdRequired: 'A Translation Memory ID is required for this operation.',
    glossaryNameRequired: 'A name is required for this Glossary operation.',
    glossaryIdRequired: 'A Glossary ID is required for this operation.',
